            ...
            <div class="col-md-2 mx-auto" style="margin-bottom:10px">
                <div class="kt-avatar kt-avatar--outline" id="kt_contacts_edit_avatar">
                    <div class="kt-avatar__holder"
                        style="background-image: url('{{ asset("files/".$item->path) }}');width:100px;height:100px">
                    </div>
                    <label class="kt-avatar__upload choosepicture" id-gambar="{{ $item->id }}"
                        path-gambar="{{ $item->path }}" data-toggle="kt-tooltip" title=""
                        data-original-title="Pilih Gambar">
