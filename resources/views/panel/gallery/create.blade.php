...
@endif
<form class="kt-form kt-form--label-right row" id="f_gallery" action="{{ route('gallery.store') }}" method="POST" enctype="multipart/form-data">
    {{csrf_field()}}
    <div class="col-md-9">
            ...
            <div class="kt-portlet__body">
                <div class="form-group row">
                    <div class="col-12 text-center">
                        <span class="">
                            <button type="button" class="btn btn-success fileinput-button col-12 addmore">Add More</button>
                        </span>
                    </div>
                </div>
            </div>
