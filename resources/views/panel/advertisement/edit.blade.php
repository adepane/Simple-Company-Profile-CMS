...
@endif
<form class="kt-form kt-form--label-right row" id="f_editadvertisement" action="{{ route('advertisement.update',$data->id) }}" method="POST" enctype="multipart/form-data">
    {{csrf_field()}}
    @method('patch')
