<li class="kt-menu__item  {{ CMS::set_active('dashboard') }} " aria-haspopup="true"><a href="{{ route('dashboard') }}"
    ...
    <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
        <ul class="kt-menu__subnav">
            ...
            <li class="kt-menu__item {{ CMS::setActive('kategori') }}" aria-haspopup="true"><a
                    href="{{ route('kategori.index') }}" class="kt-menu__link "><i
                        class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
                        class="kt-menu__link-text">Kategori</span></a></li>
            <li class="kt-menu__item {{ CMS::setActive('tag') }}" aria-haspopup="true"><a
                    href="{{ route('tag.index') }}" class="kt-menu__link "><i
                        class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
                        class="kt-menu__link-text">Tag</span></a></li>
        </ul>
    </div>
</li>
<li class="kt-menu__item  kt-menu__item--submenu {{ CMS::set_open('media') }} {{ CMS::set_open('pdf') }}"
    aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;"
        class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg"
                xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1"
                class="kt-svg-icon">
            ...
            </svg></span><span class="kt-menu__link-text">Media</span><i
            class="kt-menu__ver-arrow la la-angle-right"></i></a>
    <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
        <ul class="kt-menu__subnav">
            <li class="kt-menu__item {{ CMS::setActive('media') }}" aria-haspopup="true"><a
...
<li class="kt-menu__item  kt-menu__item--submenu {{ CMS::set_open('gallery') }}" aria-haspopup="true"
    data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span
            ...
            </svg></span><span class="kt-menu__link-text">Galeri</span><i
            class="kt-menu__ver-arrow la la-angle-right"></i></a>
    <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
        <ul class="kt-menu__subnav">
            <li class="kt-menu__item {{ CMS::set_active('gallery.index') }} {{ CMS::set_active('gallery.edit') }}"
                aria-haspopup="true"><a href="{{ route('gallery.index') }}" class="kt-menu__link "><i
                        class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
                        class="kt-menu__link-text">Semua Galeri</span></a></li>
            <li class="kt-menu__item " aria-haspopup="true"><a href="{{ route('gallery.create') }}"
...
<li class="kt-menu__item  kt-menu__item--submenu {{ CMS::set_open('slider') }}" aria-haspopup="true"
    data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span
            class="kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg"
                xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1"
                class="kt-svg-icon">
            ...
            </svg></span><span class="kt-menu__link-text">Slideshow</span><i
            class="kt-menu__ver-arrow la la-angle-right"></i></a>
    <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
        <ul class="kt-menu__subnav">
            <li class="kt-menu__item {{ CMS::set_active('slider.index') }} {{ CMS::set_active('slider.edit') }}"
                aria-haspopup="true"><a href="{{ route('slider.index') }}"
                    class="kt-menu__link {{ CMS::set_active('slider.create') }}"><i
                        class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
                        class="kt-menu__link-text">Semua Slider</span></a></li>
            <li class="kt-menu__item {{ CMS::set_active('slider.create') }}" aria-haspopup="true"><a
                    href="{{ route('slider.create') }}" class="kt-menu__link "><i
                        class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
                        class="kt-menu__link-text">Tambah Baru</span></a></li>
        </ul>
    </div>
...
<li class="kt-menu__item  {{ CMS::set_active('agenda') }} " aria-haspopup="true"><a href="{{ route('agenda.index') }}"
        class="kt-menu__link "><span class="kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg"
                xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1"
                class="kt-svg-icon">
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
...
<li class="kt-menu__item  kt-menu__item--submenu {{ CMS::set_open('announcement') }} {{ CMS::set_open('advertisement') }}"
    aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;"
        class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg"
                xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1"
                class="kt-svg-icon">
            ...
            </svg></span><span class="kt-menu__link-text">Interaksi</span><i
            class="kt-menu__ver-arrow la la-angle-right"></i></a>
    <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
        <ul class="kt-menu__subnav">
            <li class="kt-menu__item {{ CMS::setActive('announcement') }}" aria-haspopup="true"><a
                    href="{{route('announcement.index')}}" class="kt-menu__link "><i
                        class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
                        class="kt-menu__link-text">Pengumuman</span></a></li>
            <li class="kt-menu__item {{ CMS::setActive('advertisement') }}" aria-haspopup="true"><a
                    href="{{route('advertisement.index')}}" class="kt-menu__link "><i
                        class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
                        class="kt-menu__link-text">Advertisement</span></a></li>
        </ul>
    </div>
</li>
<li class="kt-menu__item  kt-menu__item--submenu {{ CMS::set_open('users') }}" aria-haspopup="true"
    data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span
            ...
            </svg></span><span class="kt-menu__link-text">Pengguna</span><i
            class="kt-menu__ver-arrow la la-angle-right"></i></a>
    <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
        <ul class="kt-menu__subnav">
            <li class="kt-menu__item {{ CMS::set_active('users.index') }}  {{ CMS::set_active('users.edit') }} "
                aria-haspopup="true"><a href="{{ route('users.index') }}" class="kt-menu__link "><i
                        class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
                        class="kt-menu__link-text">Semua Pengguna</span></a></li>
            <li class="kt-menu__item {{ CMS::set_active('users.create') }}" aria-haspopup="true"><a
                    href="{{ route('users.create') }}" class="kt-menu__link "><i
                        class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
                        class="kt-menu__link-text">Tambah Baru</span></a></li>
            <li class="kt-menu__item {{ CMS::set_active('users.show') }}" aria-haspopup="true"><a
                    href="{{ route('users.show',Auth::user()->id) }}" class="kt-menu__link "><i
                        class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
                        class="kt-menu__link-text">Profil Anda</span></a></li>
        </ul>
    </div>
</li>
<li class="kt-menu__item  kt-menu__item--submenu {{ CMS::set_open('setting') }} {{ CMS::set_open('layout') }} {{ CMS::set_open('menu') }} }}"
    aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;"
        class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon">
            ...
            </svg></span><span class="kt-menu__link-text">Pengaturan</span><i
            class="kt-menu__ver-arrow la la-angle-right"></i></a>
    <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
        <ul class="kt-menu__subnav">
            <li class="kt-menu__item {{ CMS::setActive('setting') }}" aria-haspopup="true">
                <a href="{!! route('setting.index') !!}" class="kt-menu__link "><i
                        class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
                        class="kt-menu__link-text">Umum</span></a></li>
            <li class="kt-menu__item {{ CMS::setActive('menu') }}" aria-haspopup="true"><a
                    href="{{ route('menu.index') }}" class="kt-menu__link "><i
                        class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
                        class="kt-menu__link-text">Menu</span></a></li>
        </ul>
    </div>
</li>
<li class="kt-menu__item  " aria-haspopup="true"><a href="{{ route('logout') }}"
        onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="kt-menu__link "><span
            class="kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg"
                xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1"
                class="kt-svg-icon">
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            </svg></span><span class="kt-menu__link-text">Logout</span></a></li>
